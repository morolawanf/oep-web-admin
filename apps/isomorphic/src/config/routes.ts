export const routes = {
  eCommerce: {
    ...
    campaign: '/ecommerce/campaign',
    createCampaign: '/ecommerce/campaign/create',
    CampaignDetails: (id: string) => `/ecommerce/campaign/${id}`,
    editCampaign: (id: string) => `/ecommerce/campaign/${id}/edit`,
