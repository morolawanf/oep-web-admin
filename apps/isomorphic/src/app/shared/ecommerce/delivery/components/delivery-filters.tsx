...
export default function DeliveryFilters<TData extends Record<string, any>>({ table }: TableToolbarProps<TData>) {
  ...
  return (
    <Flex align="center" justify="between" className="mb-4">
      ...
      <FilterDrawerView isOpen={openDrawer} drawerTitle="Delivery Filters" setOpenDrawer={setOpenDrawer}>
